...
console.log(`Cliente: ${currentAccount.getName()} | Conta: ${currentAccount.getAccountNumber()} | Saldo R$: ${currentAccount.getBalance().toFixed(2)}`)
currentAccount.deposit(100)
currentAccount.withdraw(50)

console.log('\n=== conta poupança ===')
const savingsAccount: SavingsAccount = new SavingsAccount('Carol', 54321)
console.log(`Cliente: ${savingsAccount.getName()} | Conta: ${savingsAccount.getAccountNumber()} | Saldo R$: ${savingsAccount.getBalance().toFixed(2)}`)
